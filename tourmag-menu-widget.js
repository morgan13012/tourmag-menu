...
`;
    ...
    <a href="https://www.tourmag.com/Le-Forum-des-Pionniers-2026-en-direct-ABO_a131787.html?utm_source=menu-tourmag" style="display: block; width: 50%; background: linear-gradient(135deg, #d32f2f, #2d1b4e); color: #ffffff; padding: 0.85rem 0.8rem; border-radius: 10px; font-weight: 700; font-size: 1rem; text-decoration: none; text-align: center; position: relative; overflow: hidden; animation: crisePulse 1.5s ease-in-out infinite; line-height: 1.3;">
