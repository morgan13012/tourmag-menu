...
/* Optimisation spécifique pour l'onglet ABONNEMENTS en responsive */

/* Écrans entre 1200px et 1400px */
@media (min-width: 1201px) and (max-width: 1400px) {
    /* Réduction des paddings généraux */
    #tourmag-menu .mega-columns.abonnes-grid .mega-column > div[style*="background: #57C6C6"] > div {
        padding: 1.2rem !important;
    }
    
    /* Onglets d'offres plus compacts */
    .offer-tab {
        padding: 0.75rem !important;
    }
    
    /* Contenu des offres plus compact */
    .offer-content {
        padding: 1.2rem !important;
    }
...
@media (min-width: 901px) and (max-width: 1200px) {
    ...
    /* Grille d'onglets plus compacte */
    #tourmag-menu .offer-tab {
        padding: 0.6rem !important;
        font-size: 0.8rem !important;
    }
    
    #tourmag-menu .offer-tab span {
        font-size: 0.85rem !important;
    ...
    /* Réduire les marges du prix */
    .offer-content > div[style*="margin-top: 1.5rem"] {
        margin-top: 1rem !important;
        padding-top: 0.75rem !important;
    }
    
    /* Bouton Abonnez-vous plus petit */
    .offer-content a[href*="bit.ly"] {
        padding: 0.65rem 1.5rem !important;
        font-size: 1rem !important;
    }
    
    /* Section Gentiane plus compacte */
    #tourmag-menu a[href*="gentiane"] {
        padding: 1rem !important;
    }
    
    /* Encadré "Articles abonnés" plus compact */
    #tourmag-menu .mega-column div[style*="border: 2px solid #ffd700"] {
        padding: 0.75rem !important;
    }
    
    #tourmag-menu .mega-column div[style*="border: 2px solid #ffd700"] > div[style*="margin-top: 1.5rem"] {
        margin-top: 1rem !important;
    }
}
...
@media (min-width: 769px) and (max-width: 900px) {
    /* Réduction maximale des paddings */
    #tourmag-menu .mega-columns.abonnes-grid .mega-column > div[style*="background: #57C6C6"] > div {
        padding: 0.75rem !important;
    }
    
    /* Grille d'onglets très compacte */
    #tourmag-menu .offer-tab {
    ...
    /* Grille des onglets avec moins d'espace */
    #tourmag-menu div[style*="display: grid; grid-template-columns: repeat(2, 1fr)"] {
        gap: 0.5rem !important;
        margin-bottom: 1rem !important;
    }
    
    /* Contenu des offres très compact */
    .offer-content {
        padding: 0.75rem !important;
    }
    ...
    /* Sous-items encore plus compacts */
    .offer-content ul li[style*="padding-left: 2.5rem"] {
...
@media (max-width: 768px) {
    /* Mega menu content ultra compact */
    #tourmag-menu .mega-menu-content {
        padding: 0.75rem 0.75rem !important;
    }
    
    /* Onglets en mode mobile - 2 colonnes compactes */
    #tourmag-menu div[style*="display: grid; grid-template-columns: repeat(2, 1fr)"] {
    ...
    /* Bouton Abonnez-vous compact */
    .offer-content a[href*="bit.ly"] {
        padding: 0.55rem 1.2rem !important;
        font-size: 0.9rem !important;
    }
    
    /* Bloc turquoise plus compact */
    #tourmag-menu .mega-columns.abonnes-grid .mega-column > div[style*="background: #57C6C6"] {
    ...
    /* Section Gentiane mobile compact */
    #tourmag-menu a[href*="gentiane"] {
        padding: 0.6rem !important;
    }
    ...
    /* Encadré articles abonnés mobile */
    #tourmag-menu .mega-column div[style*="border: 2px solid #ffd700"] {
