...
.nav-item.active .mega-menu {
    ...
    z-index: 10;
        ...
        /* BoÃ®te spéciale pour TourMaG TV et Futuroscopie */
        .special-media-box {
...
// Fix pour les cookies avec réactivation du site
...
if (window.innerWidth <= 768) {
    ...
    // Stockage des handlers pour pouvoir les retirer
