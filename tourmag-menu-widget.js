...
(function() {
    ...
    function injectCSS() {
        ...
        * {
        ...
        #tourmag-menu .nav-item:hover .nav-icon {
    ...
    will-change: transform, opacity;
        ...
        #tourmag-menu .nav-item:hover .mega-menu {
            opacity: 1;
            visibility: visible;
        ...
        #tourmag-menu .mega-sublink:hover {
    ...
    z-index: auto;
       ...
       #tourmag-menu .newsletter-item:hover {
    z-index: 100;
}
        ...
        #tourmag-menu .newsletter-item .mega-link:focus {
            outline: none;
            box-shadow: none;
        }
        ...
        #tourmag-menu .newsletter-item .mega-link .newsletter-icon img,
        #tourmag-menu .media-item .mega-link .media-icon img {
            width: 40px;
            height: 40px;
            object-fit: contain;
        ...
        #tourmag-menu .newsletter-item .mega-link .chevron {
            font-size: 0.8rem;
            color: var(--primary-blue);
            transition: transform 0.3s ease;
            margin-left: auto;
        ...
        #tourmag-menu .newsletter-item.active .mega-link .chevron {
            transform: rotate(180deg);
    ...
    z-index: 10;
        ...
        #tourmag-menu .media-item .mega-link:focus {
            outline: none;
            box-shadow: none;
        }
        ...
        #tourmag-menu .media-item .mega-link .chevron {
            font-size: 0.8rem;
            color: var(--primary-blue);
            transition: transform 0.3s ease;
            margin-left: auto;
        ...
        #tourmag-menu .media-item.active .mega-link .chevron {
            transform: rotate(180deg);
            background: rgba(0, 102, 204, 0.2);
        }
        ...
        #tourmag-menu .mega-menu.compact {
            width: 400px;
            left: auto;
            right: 0;
        }
                                ...
                                <div class="mega-columns cols-2 abonnes-grid" style="grid-template-columns: 280px 1fr; gap: 2rem;">
                                    ...
                                    <div class="mega-column" style="max-width: 280px; min-width: 280px;">
                                        <ul class="mega-links" style="display: flex; flex-direction: column; gap: 0.5rem;">
                                            <li><a href="https://www.tourmag.com/MEMBERSHIP-CLUB_r344.html" class="media-simple-link" style="background: linear-gradient(135deg, rgba(255, 215, 0, 0.15), rgba(255, 237, 78, 0.1)); padding: 0.75rem 1rem; font-size: 0.95rem;">MemberShip Club <span class="premium-badge">PREMIUM</span></a></li>
                                            <li class="media-item">
                                                <button type="button" class="mega-link" style="background: linear-gradient(135deg, rgba(255, 215, 0, 0.15), rgba(255, 237, 78, 0.1)); padding: 0.75rem 1rem; font-size: 0.95rem;">Articles abonnés <span class="premium-badge">PREMIUM</span><span class="chevron">▼</span></button>
                                                <div class="media-submenu">
                                                    <ul>
                                            ...
                                            <li><a href="https://www.tourmag.com/faq/Foire-aux-questions-Abonnements-articles_fi4792.html" class="media-simple-link" style="background: linear-gradient(135deg, rgba(255, 102, 0, 0.15), rgba(255, 102, 0, 0.1)); color: #ff6600; font-weight: 600; padding: 0.75rem 1rem; font-size: 0.95rem;">❓ FAQ</a></li>
                                        </ul>
                                    </div>
